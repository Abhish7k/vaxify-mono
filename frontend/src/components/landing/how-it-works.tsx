        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8">
          {steps.map((step, index) => (
            <div key={step.id} className="relative flex flex-col items-center">
              ...
              <div className="relative flex flex-col bg-[#F3F4F6]/50 border border-transparent rounded-4xl p-10 h-full w-full">
                <h4 className="text-center text-xl font-bold text-[#0F172A] mb-8">
                  {step.title}
                </h4>

                <div className="relative aspect-4/3 w-full bg-[#E5E7EB]/30 rounded-3xl flex items-center justify-center mb-8 border border-white/20 overflow-hidden">
                  {step.graphic}
                  <div
...
const steps = [
  {
    ...
    description:
      "Browse verified vaccination centers, view available vaccines, working hours, and real-time slot availability all in one place.",
  ...
  },
  {
    ...
    title: "Book & Manage",
    description:
      "Users select a date and time slot to book an appointment. Appointments are instantly visible to both the user and the hospital staff.",
    ...
    arrow: (
      <svg
        ...
        viewBox="0 0 40 35"
        fill="none"
        className="text-slate-400 mt-2 rotate-180"
      >
        <path
          d="M5 5C15 5 25 10 30 25M30 25L23 24M30 25L29 18"
          stroke="currentColor"
  ...
  },
  {
    ...
    description:
      "Hospital staff manage daily appointments and update vaccination status, while admins oversee hospital approvals.",
    ...
    arrow: (
      <svg
        ...
        viewBox="0 0 40 35"
        fill="none"
        className="text-slate-400 mb-2 scale-x-[-1]"
      >
        <path
          d="M5 5C15 5 25 10 30 25M30 25L23 24M30 25L29 18"
          stroke="currentColor"
    ...
    graphic: (
      <div className="w-40 space-y-3 p-2">
        ...
        <div className="bg-white rounded-lg p-2 shadow-sm border border-slate-100 flex items-center justify-between">
          ...
          <div className="px-2 py-0.5 rounded-full bg-emerald-50 text-[8px] font-bold text-emerald-600 border border-emerald-100">
            DONE
          </div>
        </div>
